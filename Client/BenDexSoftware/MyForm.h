...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->BuyTime_1->MouseCaptureChanged += gcnew System::EventHandler(this, &MyForm::BuyTime_1_MouseCaptureChanged);
			this->BuyTime_1->MouseEnter += gcnew System::EventHandler(this, &MyForm::BuyTime_1_MouseEnter);
			this->BuyTime_1->MouseLeave += gcnew System::EventHandler(this, &MyForm::BuyTime_1_MouseLeave);
			// 
			// pictureBox3
			// 
			...
			this->PCoff->Click += gcnew System::EventHandler(this, &MyForm::PCoff_Click);
			// 
			// pictureBox2
			// 
